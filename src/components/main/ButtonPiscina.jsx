...
export default function ButtonPiscina({ piscina }) {
  const [selectedPiscina, setSelectedPiscina] = useState("");
          ...
          <label
            className={`${
              selectedPiscina === piscina.piscina
                ? "outline outline-4 outline-teal-700"
                : ""
            } text-white bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gradient-to-br font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 w-32 select-none`}
            key={index}
          >
            <input
              className="appearance-none"
